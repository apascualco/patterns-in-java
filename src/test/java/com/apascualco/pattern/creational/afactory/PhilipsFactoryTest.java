...
import com.apascualco.pattern.creational.afactory.factory.Philips;
...
public class PhilipsFactoryTest {

    private final String BRAND = "Philips";

    private AbstractMonitor factory;

    public PhilipsFactoryTest() {
        this.factory = new Philips();
    }

    @Test
    public void create_Philips() {
