...
import com.apascualco.pattern.creational.mfactory.creator.AlternativeAlgorithmFactory;
import com.apascualco.pattern.creational.mfactory.creator.AlternativeAlgorithmFactoryImpl;
import org.junit.Test;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertNotNull;

public class AlternativeAlgorithmFactoryImplEpsonTest {

    private final AlternativeAlgorithmFactory algorithmFactory = new AlternativeAlgorithmFactoryImpl();

    @Test
    public void encode_sha256() {
        final String encoded = algorithmFactory.encode("Factory method", "SHA256");
    ...
    public void encode_sha384() {
        final String encoded = algorithmFactory.encode("Factory method", "SHA384");
        assertNotNull(encoded);
    ...
    public void encode_sha512() {
        final String encoded = algorithmFactory.encode("Factory method", "SHA512");
        assertNotNull(encoded);
